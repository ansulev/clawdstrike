# Phase 03: KQL Adapter Plugin - Context
...
Microsoft Sentinel KQL detection adapter plugin: parser, generator, visual builder panel, Sigma translation provider, field mappings. Uses createPlugin() SDK and Phase 1 infrastructure.
...
- Bidirectional Sigma<->KQL translation (existing sigma-conversion.ts has KQL output — add parser for inverse)
- Visual builder panel using DetectionVisualPanelKit components
- Lab execution support for testing Microsoft Sentinel KQL rules against evidence
