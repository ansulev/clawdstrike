# Phase 04: EQL Adapter Plugin - Context
...
Elastic EQL detection adapter plugin: parser, generator, visual builder panel, Sigma translation provider, field mappings. Uses createPlugin() SDK and Phase 1 infrastructure.
...
- Bidirectional Sigma<->EQL translation (existing sigma-conversion.ts has EQL output — add parser for inverse)
- Visual builder panel using DetectionVisualPanelKit components
- Lab execution support for testing Elastic EQL rules against evidence
